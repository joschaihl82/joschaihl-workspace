/*
  ...
  - Grid glyph atlas (avoids extremely tall textures)
  ...
  - Immediate local echo for snappy typing
...
int main(int argc, char *argv[])
{
  ...
  while (!quitting)
  {
    ...
    while (SDL_PollEvent(&ev))
    {
      ...
      {
        /* local echo printable text immediately, then send to PTY */
