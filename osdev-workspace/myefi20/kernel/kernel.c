...
/* Remap PIC to avoid conflicts with CPU exceptions (IRQs -> 32..47) */
static void pic_remap(void) {
    ...
    outb(PIC1_DATA, 0x20); /* PIC1 vector offset = 0x20 */
    outb(PIC2_DATA, 0x28); /* PIC2 vector offset = 0x28 */
    outb(PIC1_DATA, 0x04);
    outb(PIC2_DATA, 0x02);
    outb(PIC1_DATA, 0x01);
    outb(PIC2_DATA, 0x01);
...
/* Minimal US scancode set (make/press codes only) */
...
/* Forward declarations for exception handler C function */
void exception_handler_c(int vec, uint64_t err);

/* C-level keyboard handler called from assembly stub */
void keyboard_handler_c(void) {
    uint8_t sc = inb(0x60);
    /* Only handle make codes (no break handling here) */
    if (sc < 128) {
        char c = scancode_to_ascii[sc];
        if (c) {
            /* Print printable characters and handle newline/backspace */
            if (c == '\b') {
...
/* Generic exception assembly stubs.
   We create two kinds:
   - exceptions without error code: push 0 as error code then call handler
   - exceptions with error code: call handler directly (error code already on stack)
*/

/* Macro-like helper to define stubs in C using inline asm labels */
__attribute__((naked)) void isr_exc_noerr_0(void) { __asm__ volatile("pushq $0\n\tpushq $0\n\tpushq $0\n\tcall exception_handler_c\n\taddq $16, %rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_exc_noerr_1(void) { __asm__ volatile("pushq $1\n\tpushq $0\n\tpushq $0\n\tcall exception_handler_c\n\taddq $16, %rsp\n\tiretq\n\t"); }
/* ... we'll set up a small set of no-error stubs and reuse them for vectors without error codes */
__attribute__((naked)) void isr_exc_noerr_generic(void) {
    __asm__ volatile (
        "pushq $0\n\t"        /* error code = 0 */
        "pushq %rax\n\t"     /* placeholder for vector number (caller will push) */
        "call exception_handler_c\n\t"
        "addq $16, %rsp\n\t"
        "iretq\n\t"
    );
...
/* For exceptions with error code, the CPU pushes the error code; we need a stub that pushes vector then calls C handler */
__attribute__((naked)) void isr_exc_err_generic(void) {
    __asm__ volatile (
        "pushq %rax\n\t"     /* placeholder for vector number (caller will push) */
        "call exception_handler_c\n\t"
        "addq $8, %rsp\n\t"  /* remove pushed vector */
        "iretq\n\t"
    );
}

/* We'll instead create explicit small assembly stubs for each vector to avoid complexity.
   For simplicity and reliability, define stubs for vectors 0..31 in a compact way below.
*/

__attribute__((naked)) void isr_vector0(void)  { __asm__ volatile("pushq $0\n\tpushq $0\n\tcall exception_handler_c\n\taddq $16,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector1(void)  { __asm__ volatile("pushq $1\n\tpushq $0\n\tcall exception_handler_c\n\taddq $16,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector2(void)  { __asm__ volatile("pushq $2\n\tpushq $0\n\tcall exception_handler_c\n\taddq $16,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector3(void)  { __asm__ volatile("pushq $3\n\tpushq $0\n\tcall exception_handler_c\n\taddq $16,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector4(void)  { __asm__ volatile("pushq $4\n\tpushq $0\n\tcall exception_handler_c\n\taddq $16,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector5(void)  { __asm__ volatile("pushq $5\n\tpushq $0\n\tcall exception_handler_c\n\taddq $16,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector6(void)  { __asm__ volatile("pushq $6\n\tpushq $0\n\tcall exception_handler_c\n\taddq $16,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector7(void)  { __asm__ volatile("pushq $7\n\tpushq $0\n\tcall exception_handler_c\n\taddq $16,%rsp\n\tiretq\n\t"); }

/* Vectors with error code pushed by CPU: 8,10,11,12,13,14,17,21,29 (common ones include 8 double fault, 14 page fault) */
__attribute__((naked)) void isr_vector8(void)  { __asm__ volatile("pushq $8\n\tcall exception_handler_c\n\taddq $8,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector9(void)  { __asm__ volatile("pushq $9\n\tpushq $0\n\tcall exception_handler_c\n\taddq $16,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector10(void) { __asm__ volatile("pushq $10\n\tcall exception_handler_c\n\taddq $8,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector11(void) { __asm__ volatile("pushq $11\n\tcall exception_handler_c\n\taddq $8,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector12(void) { __asm__ volatile("pushq $12\n\tcall exception_handler_c\n\taddq $8,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector13(void) { __asm__ volatile("pushq $13\n\tcall exception_handler_c\n\taddq $8,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector14(void) { __asm__ volatile("pushq $14\n\tcall exception_handler_c\n\taddq $8,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector15(void) { __asm__ volatile("pushq $15\n\tpushq $0\n\tcall exception_handler_c\n\taddq $16,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector16(void) { __asm__ volatile("pushq $16\n\tpushq $0\n\tcall exception_handler_c\n\taddq $16,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector17(void) { __asm__ volatile("pushq $17\n\tcall exception_handler_c\n\taddq $8,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector18(void) { __asm__ volatile("pushq $18\n\tpushq $0\n\tcall exception_handler_c\n\taddq $16,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector19(void) { __asm__ volatile("pushq $19\n\tpushq $0\n\tcall exception_handler_c\n\taddq $16,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector20(void) { __asm__ volatile("pushq $20\n\tpushq $0\n\tcall exception_handler_c\n\taddq $16,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector21(void) { __asm__ volatile("pushq $21\n\tcall exception_handler_c\n\taddq $8,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector22(void) { __asm__ volatile("pushq $22\n\tpushq $0\n\tcall exception_handler_c\n\taddq $16,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector23(void) { __asm__ volatile("pushq $23\n\tpushq $0\n\tcall exception_handler_c\n\taddq $16,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector24(void) { __asm__ volatile("pushq $24\n\tpushq $0\n\tcall exception_handler_c\n\taddq $16,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector25(void) { __asm__ volatile("pushq $25\n\tpushq $0\n\tcall exception_handler_c\n\taddq $16,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector26(void) { __asm__ volatile("pushq $26\n\tpushq $0\n\tcall exception_handler_c\n\taddq $16,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector27(void) { __asm__ volatile("pushq $27\n\tpushq $0\n\tcall exception_handler_c\n\taddq $16,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector28(void) { __asm__ volatile("pushq $28\n\tpushq $0\n\tcall exception_handler_c\n\taddq $16,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector29(void) { __asm__ volatile("pushq $29\n\tcall exception_handler_c\n\taddq $8,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector30(void) { __asm__ volatile("pushq $30\n\tpushq $0\n\tcall exception_handler_c\n\taddq $16,%rsp\n\tiretq\n\t"); }
__attribute__((naked)) void isr_vector31(void) { __asm__ volatile("pushq $31\n\tpushq $0\n\tcall exception_handler_c\n\taddq $16,%rsp\n\tiretq\n\t"); }

/* C exception handler: prints vector and error code, then halts safely.
   This prevents the CPU from rebooting due to an unhandled exception.
*/
void exception_handler_c(int vec, uint64_t err) {
    /* Print a short message about the exception */
    printf("EXCEPTION: vector=%d err=0x%x\n", vec, err);

    /* For page fault (14), read CR2 to show faulting address */
    if (vec == 14) {
        uint64_t cr2;
    ...
    /* If this was triggered by an IRQ (rare for exceptions), acknowledge PICs conservatively */
    /* Halt the system in a safe loop instead of rebooting */
...
/* Initialize IDT, PIC and keyboard IRQ and exception vectors */
void init_pic_idt_keyboard(void) {
    ...
    /* Double fault (8) should use IST to avoid stack issues */
    set_idt_entry(8,  isr_vector8,  0x8E, 1); /* IST index 1 -> kernel_tss.ist[0] */
    ...
    /* set keyboard IRQ (IRQ1 -> vector 0x21 after PIC remap) */
    set_idt_entry(0x21, isr_keyboard_stub, 0x8E, 0);

    pic_remap();

    /* mask all IRQs except keyboard (unmask IRQ1) */
    outb(PIC1_DATA, 0xFD); /* 11111101 -> unmask IRQ1 only on master */
...
void init_gdt_tss() {
    /* Ensure null descriptor exists */
    gdt_table.null.limit_low = 0; gdt_table.null.base_low = 0; gdt_table.null.base_mid = 0; gdt_table.null.access = 0; gdt_table.null.gran = 0; gdt_table.null.base_high = 0;
    ...
    /* Provide a dedicated IST stack for double-fault handling */
    kernel_tss.rsp0 = (uint64_t)tss_stack + 4096;
    kernel_tss.ist[0] = (uint64_t)tss_stack + 4096; /* IST index 1 uses ist[0] */
...
void kmain(KernelGOPInfo *kgi) {
    ...
    /* install keyboard ISR and PIC/IDT and exception handlers */
    init_pic_idt_keyboard();

    /* enable interrupts now that IDT and PIC are ready */
    ...
    while(1) {
        for(uint32_t i = 0; i < screen_height * pps; i++) fbb[i] = 0x0;
        for(uint32_t i = 0; i < screen_height * pps; i++) fbb[i] = 0xffffffff;
    }
