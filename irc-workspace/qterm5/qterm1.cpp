...
void TerminalWidget::paintEvent(QPaintEvent * /*ev*/)
{
    ...
    // Draw all rows unconditionally to avoid partial-black-screen issues.
    // This is robust and simple; if you need performance, we can re-enable
    // per-line dirty optimization after further testing.
    for (int y = 0; y < rows; ++y) {
