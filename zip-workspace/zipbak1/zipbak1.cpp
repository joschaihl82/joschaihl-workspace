...
public slots:
    void process() {
        ...
        // compute sizes and collect subfolder file lists
        ...
        for (const auto &folder : folders) {
            ...
            for (const auto &fe : folder.files) {
                ...
                QThread::msleep(1); // yield to GUI; small sleep to keep UI responsive on very fast loops
            }
...
private:
    ...
    static QString formatEta(qint64 processed, qint64 total, qint64 elapsedMs) {
        ...
        double rate = double(processed) / (elapsedMs / 1000.0); // bytes/sec
