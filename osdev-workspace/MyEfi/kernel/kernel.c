...
void process_newline() {
    cursor_x = 20;
    cursor_y += line_height;
    // Wenn die NÄCHSTE Zeile außerhalb des Bildschirms läge, scrollen
...
void draw_char(char c) {
    ...
    // Automatischer Zeilenumbruch am rechten Rand
...
void kmain(KernelGOPInfo *kgi) {
    ...
    k_printf("Kernel Online. Teste Scrolling bei Newline...\n");
    
    setup_paging(kgi);
    
    // Test: Erzeuge 100 Zeilenumbrüche
    for(int i = 0; i < 10000000; i++) {
        active_color = (i % 2 == 0) ? 0xFFFF00 : 0xFFFFFF;
        k_printf("Zeile %x: Das Scrollen funktioniert jetzt bei \\n !\n", (uint64_t)i);
    }
