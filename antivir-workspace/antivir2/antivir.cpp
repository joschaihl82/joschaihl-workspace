...
namespace Collectors {
    ...
    // Häufig ausgeführte Executables via Shell-History (Heuristik)
    ...
    // Zuletzt geänderte Dateien (Priorität: Home-Verzeichnis)
...
public:
    MainWindow() : worker_(nullptr), tray_(nullptr) {
        ...
        // Automatisch: zuerst zuletzt geänderte Dateien scannen
...
int main(int argc, char *argv[]) {
    ...
    QApplication::setQuitOnLastWindowClosed(false); // Hintergrundbetrieb ohne Fenster
    ...
    MainWindow w;
    // Fenster absichtlich nicht anzeigen: w.show() entfällt
    return app.exec();
}
