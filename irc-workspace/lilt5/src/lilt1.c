/*
  ...
  - Improved child spawn: sets TERM, better exec error handling, respawn shell after one-shot command
...
/* If user launched a one-shot command (e.g., ./lilt_single top), we remember that
   so we can respawn the interactive shell after the command exits. */
