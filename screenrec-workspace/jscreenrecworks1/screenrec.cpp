...
// Uses swr_alloc_set_opts2 for resampler configuration.
...
protected:
    void run() override {
        ...
        // Use swr_alloc_set_opts2 to configure resampler
...
public slots:
    ...
    void togglePause() {
        ...
        else { m_captureTimer->start(33); m_isPaused = false; m_actionPause->setText("Pause"); m_tray->showMessage("Screen Recorder", "Resumed"); }
    }
