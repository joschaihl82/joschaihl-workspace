...
signals:
    ...
    void timeElapsedUpdated(qint64 ms); // NEU: Signal für vergangene Zeit
...
public slots:
    void processCameraData(int hotPixelCount) {
        ...
        // NEU: Vergangene Zeit aktualisieren
...
private slots:
    ...
    // NEU: Slot zur Anzeige der vergangenen Zeit
...
private:
    ...
    QLabel *m_alphaLabel;
    QLabel *m_timeElapsedLabel; // NEU: Label für vergangene Zeit
    QLabel *m_videoLabel; 
    ...
    void setupUI() {
        ...
        // Schriftgröße 20pt, Hintergrundtransparenz 100
        infoPanelWidget->setStyleSheet("background-color: rgba(30, 30, 30, 100); color: white; padding: 10px; border-radius: 5px; font-size: 20pt;");
        QVBoxLayout *infoPanel = new QVBoxLayout(infoPanelWidget);
        
        QLabel *titleLabel = new QLabel("<h3>Aktuelle Strahlung (rad/m²)</h3>");
        ...
        m_timeElapsedLabel = new QLabel(QString("Verstrichen: <b style='float:right;'>00:00:00:00:000</b>")); // NEU: Zeit-Label
        ...
        infoPanel->addWidget(m_timeElapsedLabel); // NEU: Zeit-Label einfügen
        ...
        // Schriftgröße 14pt, Hintergrundtransparenz 100
        isotopePanelWidget->setStyleSheet("background-color: rgba(30, 30, 30, 100); color: white; padding: 5px; border-radius: 5px; font-size: 14pt;");
    ...
    void setupClassesAndConnections() {
        ...
        // NEU: Verbindung für die verstrichene Zeit
