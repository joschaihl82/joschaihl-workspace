...
str_equals:
  ...
  popq %rax
  cmpq %rdi, %rax
  sete 0x0.07ffcedead2cp-1022l
  movzbq 0x0.07ffcedead2cp-1022l, %rax
  pushq %rax
  popq %rax
  cmpq $0, %rax
  je .Lfalse0
...
add_field:
  ...
  popq %rdi
  movq %rdi, %rsp
  movslq 1.018558e-312ax, %rax
  pushq %rax
  popq %rdi
  popq %rax
  movl 0.000000e+00di, (%rax)
  pushq %rdi
  popq %rax
  jmp .Lend2
.Lelse2:
...
cerror:
  ...
  pushq %r10
  popq %rax
  movl $8, 6.952704e-310ax
  movl 6.952704e-310ax, -32(%rbp)
  movl $48, 6.952704e-310ax
  movl 6.952704e-310ax, -28(%rbp)
  leaq 16(%rbp), %rax
  movq %rax, -24(%rbp)
  leaq -88(%rbp), %rax
  movq %rax, -16(%rbp)
...
.Lbegin10:
  ...
  popq %rax
  cmpq %rdi, %rax
  sete 0x0.07ffcedeacefp-1022l
  movzbq 0x0.07ffcedeacefp-1022l, %rax
  pushq %rax
  popq %rax
  cmpq $0, %rax
  je .Lend11
  ...
  pushq %rax
  popq %rax
  movl (%rax), 6.952704e-310di
  pushq %rdi
  addl $1, 6.952704e-310di
  movl 6.952704e-310di, (%rax)
  popq %rax
.Lend11:
.Lcontinue3:
...
error_at:
  ...
  pushq %r10
  popq %rax
  movl $16, 6.952704e-310ax
  movl 6.952704e-310ax, -40(%rbp)
  movl $48, 6.952704e-310ax
  movl 6.952704e-310ax, -36(%rbp)
  leaq 16(%rbp), %rax
  movq %rax, -32(%rbp)
  leaq -96(%rbp), %rax
  movq %rax, -24(%rbp)
...
.Lbegin18:
  ...
  popq %rax
  cmpq %rdi, %rax
  sete 0x0.07ffcedead01p-1022l
  movzbq 0x0.07ffcedead01p-1022l, %rax
  pushq %rax
  popq %rax
  cmpq $0, %rax
  je .Lend19
...
is_alnum:
  ...
  popq %rax
  cmpq %rdi, %rax
  setle 0x0.07ffcedeaceap-1022l
  movzbq 0x0.07ffcedeaceap-1022l, %rax
  pushq %rax
  popq %rax
  cmpq $0, %rax
  je .Lfalse22
...
.Lend29:
  ...
  popq %rdi
  movq %rdi, %rsp
  movsbq 0x0.07ffcedead2cp-1022l, %rax
  pushq %rax
  popq %rax
  cmpq $0, %rax
  je .Lend30
...
.Lend30:
  ...
  popq %rdi
  movq %rdi, %rsp
  movsbq 0x0.07f28dd76302p-1022l, %rax
  pushq %rax
  popq %rax
  cmpq $1, %rax
  je .Ltrue33
...
.Lend99:
  ...
  popq %rax
  cmpq %rdi, %rax
  setle 0x0.07f28dd76302p-1022l
  movzbq 0x0.07f28dd76302p-1022l, %rax
  pushq %rax
  popq %rax
  cmpq $0, %rax
  je .Lfalse103
...
.Lbegin114:
  ...
  popq %rdi
  movq %rdi, %rsp
  movsbq 0x0.07ffcedeacefp-1022l, %rax
  pushq %rax
  popq %rax
  cmpq $0, %rax
  je .Lend115
...
.Lbegin119:
  ...
  popq %rdi
  movq %rdi, %rsp
  movsbq 0x0.07ffcedeacf9p-1022l, %rax
  pushq %rax
  popq %rax
  cmpq $0, %rax
  je .Lend121
...
.Lcontinue15:
  ...
  popq %rdi
  movq %rdi, %rsp
  movsbq 0x0.07ffcedeace3p-1022l, %rax
  pushq %rax
  popq %rax
  cmpq $1, %rax
  je .Ltrue127
...
.Lbreak19:
  ...
  pushq %rax
  popq %rax
  movl (%rax), 1.018558e-312di
  pushq %rdi
  addl $1, 1.018558e-312di
  movl 1.018558e-312di, (%rax)
  pushq $8
  popq %rdi
  popq %rax
  imulq %rdi, %rax
...
consume:
  ...
  popq %rax
  cmpq %rdi, %rax
  setne 0x0.056016fc663a1p-1022l
  movzbq 0x0.056016fc663a1p-1022l, %rax
  pushq %rax
  popq %rax
  cmpq $1, %rax
  je .Ltrue159
...
.Lcase2_4:
  ...
  popq %rax
  cmpq %rdi, %rax
  setne 0x0.07ffcedeacfap-1022l
  movzbq 0x0.07ffcedeacfap-1022l, %rax
  pushq %rax
  popq %rdi
  movq %rsp, %r10
  andq $-16, %rsp
...
.Lbegin222:
  ...
  popq %rdi
  movq %rdi, %rsp
  movsbq 0x0.056016fc66c3cp-1022l, %rax
  pushq %rax
  popq %rax
  cmpq $0, %rax
  je .Lend223
...
.Lelse237:
  ...
  popq %rdi
  movq %rdi, %rsp
  movsbq 0x0.056016fc66744p-1022l, %rax
  pushq %rax
  popq %rax
  cmpq $0, %rax
  je .Lelse241
...
.Lelse241:
  ...
  popq %rdi
  movq %rdi, %rsp
  movsbq 0x0.07ffcedeace5p-1022l, %rax
  pushq %rax
  popq %rax
  cmpq $0, %rax
  je .Lelse244
...
.Lbegin252:
  ...
  popq %rdi
  movq %rdi, %rsp
  movsbq 0x0.07ffcedead01p-1022l, %rax
  pushq %rax
  popq %rax
  cmpq $0, %rax
  je .Lelse253
...
.Lbegin263:
  ...
  popq %rax
  cmpq %rdi, %rax
  sete 0x0.0000000000002p-1022l
  movzbq 0x0.0000000000002p-1022l, %rax
  pushq %rax
  popq %rax
  cmpq $1, %rax
  je .Ltrue266
...
.Lend265:
  ...
  popq %rax
  cmpq %rdi, %rax
  sete 0x0.07ffcedeacf1p-1022l
  movzbq 0x0.07ffcedeacf1p-1022l, %rax
  pushq %rax
  popq %rax
  cmpq $0, %rax
  je .Lend268
...
.Lelse267:
  ...
  popq %rax
  cmpq %rdi, %rax
  sete 0x0.07ffcedeacedp-1022l
  movzbq 0x0.07ffcedeacedp-1022l, %rax
  pushq %rax
  popq %rax
  cmpq $0, %rax
  je .Lend270
...
.Lelse271:
  ...
  popq %rdi
  movq %rdi, %rsp
  movsbq 0x0.07ffcedeacedp-1022l, %rax
  pushq %rax
  popq %rax
  cmpq $0, %rax
  je .Lelse274
...
unary:
  ...
  popq %rdi
  movq %rdi, %rsp
  movsbq 0x0.056019cd52c5p-1022l, %rax
  pushq %rax
  popq %rax
  cmpq $0, %rax
  je .Lelse284
...
.Lelse285:
  ...
  popq %rdi
  movq %rdi, %rsp
  movsbq 0x0.07ffcedeacf1p-1022l, %rax
  pushq %rax
  popq %rax
  cmpq $0, %rax
  je .Lelse287
...
primary:
  ...
  popq %rdi
  movq %rdi, %rsp
  movsbq 0x0.056019cd6cp-1022l, %rax
  pushq %rax
  popq %rax
  cmpq $0, %rax
  je .Lend312
...
.Lcontinue45:
  ...
  pushq %rax
  popq %rax
  movl (%rax), 4.672091e-310di
  pushq %rdi
  addl $1, 4.672091e-310di
  movl 4.672091e-310di, (%rax)
  popq %rax
  jmp .Lbegin319
.Lend319:
...
gen_lval:
  ...
  popq %rax
  cmpq %rdi, %rax
  sete 0x0.056019cd7063p-1022l
  movzbq 0x0.056019cd7063p-1022l, %rax
  pushq %rax
  popq %rax
  cmpq $0, %rax
  je .Lelse334
...
.Lbegin353:
  ...
  popq %rax
  cmpq %rdi, %rax
  setle 0x0.07ffcedeacf9p-1022l
  movzbq 0x0.07ffcedeacf9p-1022l, %rax
  pushq %rax
  popq %rax
  cmpq $0, %rax
  je .Lelse354
