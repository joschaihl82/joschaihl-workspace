...
int main(int argc, char **argv) {
    ...
    while (!quit) {
        ...
        if (ioctl(fd, VIDIOC_DQBUF, &buf) == 0) {
            ...
            // Initialize background quickly on first frames
            if (reset_bg) {
            ...
            // Overlay anomalies as "Radionullon ghosts"
            ...
            // Non-blocking: tiny sleep to avoid busy loop
            ts.tv_sec = 0; ts.tv_nsec = 5000000; // 5ms
            nanosleep(&ts, NULL);
        }
        ...
        while (SDL_PollEvent(&e)) {
            ...
            if (e.type == SDL_KEYDOWN) {
                ...
                if (e.key.keysym.sym == SDLK_b) reset_bg = true; // rebuild background
            }
        }
    }
