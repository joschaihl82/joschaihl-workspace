 ...
 *   ./sparrow
 *
 * This file has been organized so that all forward declarations are present
 * and the tests[] array and Test typedef are defined before main.
 */
...
/* ---------------------------
   IMPORTANT: parse_primary supports function expressions now
   --------------------------- */
