...
/* ---------- Professional Surveillance Preset ---------- */
static const float SEPIA_HUE_DEG = 32.0f;
static const float SEPIA_SAT_MULT = 0.52f;
static const float SEPIA_VAL_MULT = 1.18f;
static const float GHOST_ALPHA = 0.35f;
static const float HSVA_EXPOSURE = 1.12f;

/* Contrast v3.0 - Surveillance Optimized */
static const float CONTRAST_EMA_ALPHA = 0.09f;
static const float TARGET_STD_MULT = 2.0f;
static const float CONTRAST_GAIN_MIN = 0.85f;
static const float CONTRAST_GAIN_MAX = 3.8f;
static const float CONTRAST_APPLY_CLAMP = 0.94f;
static const float HISTORY_DECAY = 0.48f;
