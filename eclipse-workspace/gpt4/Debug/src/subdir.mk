...
clean-src:
	-$(RM) ./src/common.d ./src/common.o ./src/console.d ./src/console.o ./src/ggml-alloc.d ./src/ggml-alloc.o ./src/ggml-backend-reg.d ./src/ggml-backend-reg.o ./src/ggml-backend.d ./src/ggml-backend.o ./src/ggml-opt.d ./src/ggml-opt.o ./src/ggml-quants.d ./src/ggml-quants.o ./src/ggml-threading.d ./src/ggml-threading.o ./src/ggml.d ./src/ggml.o ./src/json-schema-to-grammar.d ./src/json-schema-to-grammar.o ./src/llama-grammar.d ./src/llama-grammar.o ./src/llama-sampling.d ./src/llama-sampling.o ./src/llama-vocab.d ./src/llama-vocab.o ./src/llama.d ./src/llama.o ./src/log.d ./src/log.o ./src/run.d ./src/run.o ./src/unicode-data.d ./src/unicode-data.o ./src/unicode.d ./src/unicode.o
