...
int main(void) {
    ...
    /* Use sweep 880 Hz -> 1760 Hz (880 * 2) as requested */
    ctx_siren wctx = {880.0, 1760.0, 12.0/60.0};   /* slow wail */
    ctx_siren yctx = {880.0, 1760.0, 180.0/60.0};  /* fast yelp */
    ...
    close_snd(pcm);
    printf("Done: %d cycles of wail+ yelp at 880->1760 Hz with %d ms fades\n", ITERATIONS, FADE_MS);
    return 0;
}
